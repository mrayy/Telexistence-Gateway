...
public class UINEDOMessage : MonoBehaviour {
	...
	public UIWidget messageHandler;
	public UILabel messageLabel;
	public UI2DSprite msgBackground;
	...
	public void SetMessage(string msg,MessageLevel level)
	{
		...
		case MessageLevel.Info:
			msgBackground.sprite2D=InfoBG;
			_blinkSpeed=1;
			break;
		case MessageLevel.Warning:
			msgBackground.sprite2D=WarningBG;
			_blinkSpeed=3;
			break;
		case MessageLevel.Error:
			msgBackground.sprite2D=ErrorBG;
			_blinkSpeed=5;
			break;
		}
	}
